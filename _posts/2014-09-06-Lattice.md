...
## Introduction:
A light theme with a active top clock and stylish search menu from css tricks.  
The main menu has been repositioned to the upper part of the page with no option to collapse.
